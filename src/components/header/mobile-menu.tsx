...
const MobileMenu = ({ hasCondominium = true, hasVideo = true }: MobileMenuProps) => {
  ...
  return (
    <div className="relative">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-opacity-30 backdrop-blur-lg shadow-lg py-4 max-w-[1200px] rounded-3xl mt-4 mx-4 flex justify-between items-center px-6">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 z-40 flex flex-col items-center justify-start h-full bg-opacity-30 backdrop-blur-lg shadow-lg text-white py-16 px-8 mx-4 mt-20 rounded-3xl rounded-b-xl"
          >
            ...
            >
              <a href="#contato">
                <button className="bg-gradient text-black font-bold px-6 py-3 rounded-full bg-[#BFB4AA] transition duration-300">
                  Entre em contato
                </button>
              </a>
            </motion.div>
